...
public:
  ...
  // Main API
  std::vector<blockid_t> SelectVictimBlockToGCRead(int victim_cnt);
  ...
  std::vector<blockid_t> SelectVictimBlocksToGCWrite();
  ...
  bool ShouldSelectImbalancedBlock();
  int GreedyAmongImbalancedGroups();
