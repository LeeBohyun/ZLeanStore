...
public:
  ...
  void IssueZoneAppend(u64 zone_offset, void *buffer, u64 size);
  void IssueZoneAppendWAL(void *buffer, u64 size);
  void IssueZoneAppendStorage(u64 zone_offset, void *buffer, u64 size);
  void IssueZoneReset(u64 zone_offset);
  void ZNSRead(u64 zone_offset, void *buffer, u32 size);
