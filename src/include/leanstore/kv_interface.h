...
public:
  ...
  // -------------------------------------------------------------------------------------
  virtual auto LookUp(std::span<u8> key,
  ...
  virtual auto Update(std::span<u8> key,
                      std::span<const u8> payload) -> bool = 0;
  virtual auto UpdateInPlace(std::span<u8> key,
                             const PayloadFunc &func) -> bool = 0;
  ...
  virtual auto AllocPID(u8 *payload) -> bool = 0;
