...
public:
  ...
  TransactionManager(buffer::BufferManager *buffer_manager,
  ...
  void
  StartTransaction(Transaction::Type next_tx_type,
                   IsolationLevel next_tx_isolation_level =
                       ParseIsolationLevel(FLAGS_txn_default_isolation_level),
