...
auto LogWorker::ReservePageImageLog(u64 payload_size, pageid_t pid,
                                    u64 offset) -> PageImgEntry & {
...
auto LogWorker::ReservePID2OffsetLog(pageid_t pid,
                                     u64 offset) -> PID2OffsetEntry & {
...
auto LogWorker::ReserveBlobLogEntry(u64 payload_size,
                                    u16 part_id) -> BlobEntry & {
