...
auto BTree::IterateAllNodes(
    GuardO<BTreeNode> &node, const std::function<u64(BTreeNode &)> &inner_fn,
...
auto BTree::IterateUntils(
    GuardO<BTreeNode> &node, const std::function<bool(BTreeNode &)> &inner_fn,
...
bool BTree::AllocPID(u8 *payload) {
...
auto BTree::LookUpBlob(std::span<const u8> blob_key,
                       ...
                       const PayloadFunc &read_cb) -> bool {
