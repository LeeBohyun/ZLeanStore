...
DEFINE_bool(
    wiki_clear_cache_before_expr, false,
    "Whether to clear the cache, i.e. page cache in OS or buffer pool in DB, "
    "before running the experiment");
DEFINE_string(wiki_workload_config_path,
              "/home/lbh/git/LeanStoreOOPW/benchmark/src/wikipedia/summary.csv",
              "The CSV file which contains Wikipedia workload characteristics");
DEFINE_string(
    wiki_articles_path,
    "/home/lbh/git/LeanStoreOOPW/benchmark/src/wikipedia/articles",
