...
template <class RecordBase>
auto LeanStoreAdapter<RecordBase>::UpdatePID(pageid_t pid,
                                             u8 *payload) -> bool {
...
template <class RecordBase>
auto LeanStoreAdapter<RecordBase>::AllocPID(u8 *payload) -> bool {
  return tree_->AllocPID(payload);
}
...
template <class RecordBase>
auto LeanStoreAdapter<RecordBase>::RegisterBlob(
    std::span<u8> blob_payload, std::span<u8> prev_blob,
