...
using YCSB120B = ycsb::YCSBWorkloadNoBlobRep<FilesystemAdapter,
                                             benchmark::FileRelation<0, 120>>;
using YCSB4K = ycsb::YCSBWorkloadNoBlobRep<FilesystemAdapter,
                                           benchmark::FileRelation<0, 4096>>;
using YCSB100K =
    ycsb::YCSBWorkloadNoBlobRep<FilesystemAdapter,
                                benchmark::FileRelation<0, 102400>>;
using YCSB1M = ycsb::YCSBWorkloadNoBlobRep<FilesystemAdapter,
                                           benchmark::FileRelation<0, 1048576>>;
using YCSB10M =
    ycsb::YCSBWorkloadNoBlobRep<FilesystemAdapter,
                                benchmark::FileRelation<0, 10485760>>;
...
auto main(int argc, char **argv) -> int {
  ...
  auto db =
      std::make_unique<FilesystemAsDB>(FLAGS_db_path, FLAGS_fs_enable_fsync);
  std::unique_ptr<ycsb::YCSBWorkloadInterface> ycsb;
  switch (FLAGS_ycsb_max_payload_size) {
  case ycsb::BLOB_NORMAL_PAYLOAD:
    ycsb = std::make_unique<YCSB120B>(
        FLAGS_ycsb_record_count, FLAGS_ycsb_read_ratio, FLAGS_ycsb_zipf_theta,
        false, payloads, db.get());
    break;
  case 4096:
    ycsb = std::make_unique<YCSB4K>(
        FLAGS_ycsb_record_count, FLAGS_ycsb_read_ratio, FLAGS_ycsb_zipf_theta,
        false, payloads, db.get());
    break;
  case 102400:
    ycsb = std::make_unique<YCSB100K>(
        FLAGS_ycsb_record_count, FLAGS_ycsb_read_ratio, FLAGS_ycsb_zipf_theta,
        false, payloads, db.get());
    break;
  case 1048576:
    ycsb = std::make_unique<YCSB1M>(
        FLAGS_ycsb_record_count, FLAGS_ycsb_read_ratio, FLAGS_ycsb_zipf_theta,
        false, payloads, db.get());
    break;
  case 10485760:
    ycsb = std::make_unique<YCSB10M>(
        FLAGS_ycsb_record_count, FLAGS_ycsb_read_ratio, FLAGS_ycsb_zipf_theta,
        false, payloads, db.get());
    break;
  default:
